...
THEORY ListIncludesX IS
  List_Includes(Implementation(MainControl_i))==(ControlUnit1,ControlUnit2,MailBox);
  Inherited_List_Includes(Implementation(MainControl_i))==(MailBox,ControlUnit2,ControlUnit1)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Implementation(MainControl_i))==(cu1_current_main_state: MAIN_STATE & cu1_current_running_state: RUNNING_STATE & cu1_current_on_state: ON_STATE & cu1_new_main_state: MAIN_STATE & cu1_new_running_state: RUNNING_STATE & cu1_new_on_state: ON_STATE & cu2_current_main_state: MAIN_STATE & cu2_current_running_state: RUNNING_STATE & cu2_current_on_state: ON_STATE & cu2_new_main_state: MAIN_STATE & cu2_new_running_state: RUNNING_STATE & cu2_new_on_state: ON_STATE)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(MainControl_i))==(cu1_current_main_state:=OFF;cu1_current_running_state:=UNKNOWN;cu1_current_on_state:=ON_IDLE;cu1_new_main_state:=OFF;cu1_new_running_state:=UNKNOWN;cu1_new_on_state:=ON_IDLE;cu2_current_main_state:=OFF;cu2_current_running_state:=UNKNOWN;cu2_current_on_state:=ON_IDLE;cu2_new_main_state:=OFF;cu2_new_running_state:=UNKNOWN;cu2_new_on_state:=ON_IDLE);
  Context_List_Initialisation(Implementation(MainControl_i))==(skip);
  List_Initialisation(Implementation(MainControl_i))==(cu1_current_main_state:=OFF;cu1_current_running_state:=UNKNOWN;cu1_current_on_state:=ON_IDLE;cu1_new_main_state:=OFF;cu1_new_running_state:=UNKNOWN;cu1_new_on_state:=ON_IDLE;cu2_current_main_state:=OFF;cu2_current_running_state:=UNKNOWN;cu2_current_on_state:=ON_IDLE;cu2_new_main_state:=OFF;cu2_new_running_state:=UNKNOWN;cu2_new_on_state:=ON_IDLE)
END
&
...
THEORY ListInstanciatedParametersX IS
  List_Instanciated_Parameters(Implementation(MainControl_i),Machine(ControlUnit1))==(?);
...
THEORY ListConstraintsX IS
  ...
  List_Constraints(Implementation(MainControl_i),Machine(ControlUnit1))==(btrue)
END
&
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(MainControl_i))==(run);
  List_Operations(Implementation(MainControl_i))==(run)
END
&
THEORY ListInputX IS
  List_Input(Implementation(MainControl_i),run)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Implementation(MainControl_i),run)==(?)
END
&
THEORY ListHeaderX IS
  List_Header(Implementation(MainControl_i),run)==(run)
END
&
THEORY ListPreconditionX IS
  Own_Precondition(Implementation(MainControl_i),run)==(btrue);
  List_Precondition(Implementation(MainControl_i),run)==(btrue)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(MainControl_i),run)==(btrue | (cu1_current_main_state: MAIN_STATE | @(next_main_state$0).(next_main_state$0: NEXT_MAIN_STATE[{cu1_current_main_state}] ==> cu1_new_main_state:=next_main_state$0));(cu1_new_main_state = ON ==> (cu1_current_on_state: ON_STATE | @(next_on_state$0).(next_on_state$0: NEXT_ON_STATE[{cu1_current_on_state}] ==> cu1_new_on_state:=next_on_state$0)) [] not(cu1_new_main_state = ON) ==> skip);(cu1_new_on_state = RUNNING ==> (cu1_current_running_state: RUNNING_STATE | @(next_running_state$0).(next_running_state$0: NEXT_RUNNING_STATE[{cu1_current_running_state}] ==> cu1_new_running_state:=next_running_state$0)) [] not(cu1_new_on_state = RUNNING) ==> skip);(cu2_current_main_state: MAIN_STATE | @(next_main_state$0).(next_main_state$0: NEXT_MAIN_STATE[{cu2_current_main_state}] ==> cu2_new_main_state:=next_main_state$0));(cu2_new_main_state = ON ==> (cu2_current_on_state: ON_STATE | @(next_on_state$0).(next_on_state$0: NEXT_ON_STATE[{cu2_current_on_state}] ==> cu2_new_on_state:=next_on_state$0)) [] not(cu2_new_main_state = ON) ==> skip);(cu2_new_on_state = RUNNING ==> (cu2_current_running_state: RUNNING_STATE | @(next_running_state$0).(next_running_state$0: NEXT_RUNNING_STATE[{cu2_current_running_state}] ==> cu2_new_running_state:=next_running_state$0)) [] not(cu2_new_on_state = RUNNING) ==> skip));
  List_Substitution(Implementation(MainControl_i),run)==(cu1_new_main_state <-- cu1_next_main_state(cu1_current_main_state);IF cu1_new_main_state = ON THEN cu1_new_on_state <-- cu1_next_on_state(cu1_current_on_state) END;IF cu1_new_on_state = RUNNING THEN cu1_new_running_state <-- cu1_next_running_state(cu1_current_running_state) END;cu2_new_main_state <-- cu2_next_main_state(cu2_current_main_state);IF cu2_new_main_state = ON THEN cu2_new_on_state <-- cu2_next_on_state(cu2_current_on_state) END;IF cu2_new_on_state = RUNNING THEN cu2_new_running_state <-- cu2_next_running_state(cu2_current_running_state) END)
END
&
THEORY ListConstantsX IS
  List_Valuable_Constants(Implementation(MainControl_i))==(?);
  Inherited_List_Constants(Implementation(MainControl_i))==(CU1_IS_FIRST_SLAVE,CU2_IS_FIRST_SLAVE);
...
THEORY ListPropertiesX IS
  ...
  Context_List_Properties(Implementation(MainControl_i))==(NEXT_RUNNING_STATE: RUNNING_STATE <-> RUNNING_STATE & NEXT_MAIN_STATE: MAIN_STATE <-> MAIN_STATE & NEXT_ON_STATE: ON_STATE <-> ON_STATE & NEXT_MAIN_STATE = {OFF|->ON,SHUTDOWN|->ON,ON|->SHUTDOWN,ERROR|->SHUTDOWN,ON|->ERROR} & NEXT_ON_STATE = {INITIALIZING|->RUNNING,ON_IDLE|->INITIALIZING} & NEXT_RUNNING_STATE = {UNKNOWN|->MASTER,UNKNOWN|->SLAVE,SLAVE|->MASTER} & U_MIN: NAT & U_UNDER: NAT & U_OVER: NAT & U_HIGH: NAT & U_LOW: NAT & RUNNING_STATE: FIN(INTEGER) & not(RUNNING_STATE = {}) & MAIN_STATE: FIN(INTEGER) & not(MAIN_STATE = {}) & ON_STATE: FIN(INTEGER) & not(ON_STATE = {}));
  Inherited_List_Properties(Implementation(MainControl_i))==(CU1_IS_FIRST_SLAVE: BOOL & CU2_IS_FIRST_SLAVE: BOOL);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(MainControl_i),Machine(MailBox))==(mb_getCurrentU,mb_getCU1Error,mb_getCU2Error,mb_set_on_state,mb_set_running_state,mb_set_main_state);
  List_Included_Operations(Implementation(MainControl_i),Machine(ControlUnit2))==(cu2_next_main_state,cu2_next_on_state,cu2_next_running_state,cu2_run);
  List_Included_Operations(Implementation(MainControl_i),Machine(ControlUnit1))==(cu1_next_main_state,cu1_next_on_state,cu1_next_running_state,cu1_run)
END
&
THEORY InheritedEnvX IS
  VisibleVariables(Implementation(MainControl_i))==(Type(cu1_current_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu1_current_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu1_current_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu1_new_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu1_new_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu1_new_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu2_current_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu2_current_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu2_current_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu2_new_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu2_new_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu2_new_on_state) == Mvv(etype(ON_STATE,?,?)));
  Operations(Implementation(MainControl_i))==(Type(run) == Cst(No_type,No_type))
END
&
THEORY ListVisibleStaticX IS
  ...
  List_Constants(Implementation(MainControl_i),Machine(ControlUnit1))==(CU1_IS_FIRST_SLAVE);
  List_Constants_Env(Implementation(MainControl_i),Machine(ControlUnit1))==(Type(CU1_IS_FIRST_SLAVE) == Cst(btype(BOOL,?,?)));
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(MainControl_i)) == (? | CU2_IS_FIRST_SLAVE,CU1_IS_FIRST_SLAVE | ? | ? | run | ? | seen(Machine(CTX)),imported(Machine(ControlUnit1)),imported(Machine(ControlUnit2)),imported(Machine(MailBox)) | ? | MainControl_i);
  List_Of_HiddenCst_Ids(Implementation(MainControl_i)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(MainControl_i)) == (CU2_IS_FIRST_SLAVE,CU1_IS_FIRST_SLAVE);
  ...
  List_Of_Ids(Machine(MailBox)) == (? | ? | ? | ? | mb_getCurrentU,mb_getCU1Error,mb_getCU2Error,mb_set_on_state,mb_set_running_state,mb_set_main_state | ? | seen(Machine(CTX)) | ? | MailBox);
...
THEORY ConstantsEnvX IS
  Constants(Implementation(MainControl_i)) == (Type(CU1_IS_FIRST_SLAVE) == Cst(btype(BOOL,?,?));Type(CU2_IS_FIRST_SLAVE) == Cst(btype(BOOL,?,?)))
END
&
THEORY VisibleVariablesEnvX IS
  VisibleVariables(Implementation(MainControl_i)) == (Type(cu2_new_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu2_new_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu2_new_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu2_current_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu2_current_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu2_current_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu1_new_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu1_new_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu1_new_main_state) == Mvv(etype(MAIN_STATE,?,?));Type(cu1_current_on_state) == Mvv(etype(ON_STATE,?,?));Type(cu1_current_running_state) == Mvv(etype(RUNNING_STATE,?,?));Type(cu1_current_main_state) == Mvv(etype(MAIN_STATE,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(MainControl_i))==(cu1_current_main_state: MAIN_STATE & cu1_current_running_state: RUNNING_STATE & cu1_current_on_state: ON_STATE & cu1_new_main_state: MAIN_STATE & cu1_new_running_state: RUNNING_STATE & cu1_new_on_state: ON_STATE & cu2_current_main_state: MAIN_STATE & cu2_current_running_state: RUNNING_STATE & cu2_current_on_state: ON_STATE & cu2_new_main_state: MAIN_STATE & cu2_new_running_state: RUNNING_STATE & cu2_new_on_state: ON_STATE)
END
&
THEORY ImportedVariablesListX IS
  ImportedVariablesList(Implementation(MainControl_i),Machine(ControlUnit1))==(?);
  ImportedVisVariablesList(Implementation(MainControl_i),Machine(ControlUnit1))==(?);
