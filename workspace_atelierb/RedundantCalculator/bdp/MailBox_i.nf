...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(MailBox_i),mb_get_cu_on_state)==(level: NAT & cu: NAT | cu = 1 ==> (level = 0 ==> resp_cu_on_state:=prev_cu1_on_state [] not(level = 0) ==> resp_cu_on_state:=cu1_on_state) [] not(cu = 1) ==> (level = 0 ==> resp_cu_on_state:=prev_cu2_on_state [] not(level = 0) ==> resp_cu_on_state:=cu2_on_state));
  Expanded_List_Substitution(Implementation(MailBox_i),mb_get_cu_running_state)==(level: NAT & cu: NAT | cu = 1 ==> (level = 0 ==> resp_cu_running_state:=prev_cu1_running_state [] not(level = 0) ==> resp_cu_running_state:=cu1_running_state) [] not(cu = 1) ==> (level = 0 ==> resp_cu_running_state:=prev_cu2_running_state [] not(level = 0) ==> resp_cu_running_state:=cu2_running_state));
  ...
  List_Substitution(Implementation(MailBox_i),mb_get_cu_running_state)==(IF cu = 1 THEN IF level = 0 THEN resp_cu_running_state:=prev_cu1_running_state ELSE resp_cu_running_state:=cu1_running_state END ELSE IF level = 0 THEN resp_cu_running_state:=prev_cu2_running_state ELSE resp_cu_running_state:=cu2_running_state END END);
  List_Substitution(Implementation(MailBox_i),mb_get_cu_on_state)==(IF cu = 1 THEN IF level = 0 THEN resp_cu_on_state:=prev_cu1_on_state ELSE resp_cu_on_state:=cu1_on_state END ELSE IF level = 0 THEN resp_cu_on_state:=prev_cu2_on_state ELSE resp_cu_on_state:=cu2_on_state END END);
