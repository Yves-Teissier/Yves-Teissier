...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(Main_i),run)==(btrue | (btrue | skip);(btrue | skip);(1: NAT & 1: NAT | @(resp_cu_running_state$0).(resp_cu_running_state$0: RUNNING_STATE ==> m_cu1_current_running_state:=resp_cu_running_state$0));(1: NAT & 2: NAT | @(resp_cu_running_state$0).(resp_cu_running_state$0: RUNNING_STATE ==> m_cu2_current_running_state:=resp_cu_running_state$0));(1: NAT & 1: NAT | @(resp_cu_main_state$0).(resp_cu_main_state$0: MAIN_STATE ==> m_cu1_current_main_state:=resp_cu_main_state$0));(1: NAT & 2: NAT | @(resp_cu_main_state$0).(resp_cu_main_state$0: MAIN_STATE ==> m_cu2_current_main_state:=resp_cu_main_state$0));(1: NAT & 1: NAT | @(resp_cu_on_state$0).(resp_cu_on_state$0: ON_STATE ==> m_cu1_current_on_state:=resp_cu_on_state$0));(1: NAT & 2: NAT | @(resp_cu_on_state$0).(resp_cu_on_state$0: ON_STATE ==> m_cu2_current_on_state:=resp_cu_on_state$0));(m_cu1_current_on_state: ON_STATE & 1: NAT | skip);(m_cu2_current_on_state: ON_STATE & 2: NAT | skip);(m_cu1_current_running_state: RUNNING_STATE & 1: NAT | skip);(m_cu2_current_running_state: RUNNING_STATE & 2: NAT | skip);(m_cu1_current_main_state: MAIN_STATE & 1: NAT | skip);(m_cu2_current_main_state: MAIN_STATE & 2: NAT | skip));
  List_Substitution(Implementation(Main_i),run)==(cu1_run;cu2_run;m_cu1_current_running_state <-- mb_get_cu_running_state(1,1);m_cu2_current_running_state <-- mb_get_cu_running_state(1,2);m_cu1_current_main_state <-- mb_get_cu_main_state(1,1);m_cu2_current_main_state <-- mb_get_cu_main_state(1,2);m_cu1_current_on_state <-- mb_get_cu_on_state(1,1);m_cu2_current_on_state <-- mb_get_cu_on_state(1,2);print_on_state(m_cu1_current_on_state,1);print_on_state(m_cu2_current_on_state,2);print_running_state(m_cu1_current_running_state,1);print_running_state(m_cu2_current_running_state,2);print_main_state(m_cu1_current_main_state,1);print_main_state(m_cu2_current_main_state,2))
END
&
